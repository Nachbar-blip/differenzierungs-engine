...
// Anzeigenamen fuer Empfehlungs-Links (jeder EMPFEHLUNGEN-href braucht
// einen Eintrag - Lint in _test_waage_logik.js)
const TRAINER_NAMEN = {
...
// Empfehlungs-Schwelle: Links erst ab so vielen Vorkommen eines Musters
// (ODER wenn die Stufe nicht komplett selbst geloest wurde) - Policy in
// empfehlungs_hrefs (waage-logik.js).
const EMPFEHLUNGS_SCHWELLE = 2;

// Einseitig-Fallback aus MUSTER_TEXTE.einseitig ableiten (ein Pflegepunkt
// statt Zweittext): Kern uebernehmen, Konsequenz + Regel anhaengen.
const _einseitigKern = MUSTER_TEXTE["einseitig"].replace(" - die Waage kippt!", "");
// Schuelersichtbare Texte der UI-Schicht (waage.js rendert via innerHTML;
// {n} = Platzhalter fuer die Loesung)
const TEXTE = {
  // Standard-Texte, falls eine Fehl-Op keinen kuratierten Fallen-Text hat
  // (Schluessel = fehler-Codes von wende_an)
  fehler: {
    "einseitig": "Du hast " + _einseitigKern.charAt(0).toLowerCase() + _einseitigKern.slice(1) +
      " \u2013 das Gleichgewicht geht verloren. Immer beide Seiten gleich behandeln.",
    "nicht-teilbar": "So l\u00e4sst sich nicht alles in gleich gro\u00dfe Portionen aufteilen \u2013 es entstehen Bruchst\u00fccke. Versuch erst etwas anderes.",
    "negativ": "So viel liegt gar nicht auf der Waage \u2013 du kannst nicht mehr wegnehmen, als da ist.",
    "unbekannte-art": "Dieser Schritt bringt dich nicht weiter \u2013 er macht die Gleichung voller statt leerer."
  },
  // Eskalation: dieselbe Fehl-Kategorie zum 2. Mal in DERSELBEN Aufgabe
  eskalation: "<strong>Das war schon mal die gleiche Falle.</strong> Tipp: Schau, was auf " +
    "BEIDEN Seiten passiert \u2013 oder wirf einen Blick in den Gleichung-Tab.<br>",
  // Kipp-Feedback (kippt = Seite, die leichter wuerde -> geht nach oben)
  kipp: {
    links: "Die linke Seite w\u00fcrde leichter und ginge nach oben.",
    rechts: "Die rechte Seite w\u00fcrde leichter und ginge nach oben."
  },
  // Erfolgs-Satzbausteine ({n} = formatierte Loesung)
  geloestWaage: "x = {n} \u2013 die Kiste wiegt {n}!",
  geloestOhneWaage: "x = {n} \u2013 auch ohne Waage sicher gel\u00f6st!",
  geloestMitHilfe: "Du hast dir Schritte zeigen lassen \u2013 beim n\u00e4chsten Mal schaffst du es allein.",
  geloestSelbst: "Stark, das hast du selbst geschafft!"
};

const STUFEN = [
  // ---------- Stufe 1: x + a = b (Wegnehmen) ----------
  { nr: 1, name: "Wegnehmen", aufgaben: [
    { id: "w1-01", stufe: 1, start: { xL: 1, cL: 2, xR: 0, cR: 5 }, waage: true,
      fallen_ops: [
    ...
    { id: "w1-02", stufe: 1, start: { xL: 1, cL: 3, xR: 0, cR: 7 }, waage: true,
      fallen_ops: [
    ...
    { id: "w1-03", stufe: 1, start: { xL: 1, cL: 4, xR: 0, cR: 9 }, waage: true,
      fallen_ops: [
    ...
    { id: "w1-04", stufe: 1, start: { xL: 1, cL: 5, xR: 0, cR: 11 }, waage: true,
      fallen_ops: [
  ...
  { nr: 2, name: "Aufteilen", aufgaben: [
    { id: "w2-01", stufe: 2, start: { xL: 2, cL: 0, xR: 0, cR: 6 }, waage: true,
      fallen_ops: [
    ...
    { id: "w2-02", stufe: 2, start: { xL: 3, cL: 0, xR: 0, cR: 12 }, waage: true,
      fallen_ops: [
    ...
    { id: "w2-03", stufe: 2, start: { xL: 4, cL: 0, xR: 0, cR: 8 }, waage: true,
      fallen_ops: [
    ...
    { id: "w2-04", stufe: 2, start: { xL: 5, cL: 0, xR: 0, cR: 15 }, waage: true,
      fallen_ops: [
    ...
    { id: "w2-05", stufe: 2, start: { xL: 6, cL: 0, xR: 0, cR: 12 }, waage: true,
      fallen_ops: [
    ...
    { id: "w2-06", stufe: 2, start: { xL: 3, cL: 0, xR: 0, cR: 9 }, waage: true,
      fallen_ops: [
        { op: { art: "div", wert: 3, seite: "links" }, muster: "einseitig",
  ...
  { nr: 3, name: "Zwei Schritte", aufgaben: [
    { id: "w3-01", stufe: 3, start: { xL: 2, cL: 3, xR: 0, cR: 7 }, waage: true,
      fallen_ops: [
    ...
    { id: "w3-02", stufe: 3, start: { xL: 3, cL: 2, xR: 0, cR: 8 }, waage: true,
      fallen_ops: [
    ...
    { id: "w3-03", stufe: 3, start: { xL: 4, cL: 1, xR: 0, cR: 9 }, waage: true,
      fallen_ops: [
    ...
    { id: "w3-04", stufe: 3, start: { xL: 2, cL: 5, xR: 0, cR: 11 }, waage: true,
      fallen_ops: [
        { op: { art: "div", wert: 2, seite: "beide" }, muster: "zu-frueh-teilen",
    ...
    { id: "w3-05", stufe: 3, start: { xL: 5, cL: 3, xR: 0, cR: 13 }, waage: true,
      fallen_ops: [
    ...
    { id: "w3-06", stufe: 3, start: { xL: 3, cL: 4, xR: 0, cR: 13 }, waage: true,
      fallen_ops: [
        { op: { art: "div", wert: 3, seite: "beide" }, muster: "zu-frueh-teilen",
  ...
  { nr: 4, name: "x auf beiden Seiten", aufgaben: [
    { id: "w4-01", stufe: 4, start: { xL: 3, cL: 2, xR: 1, cR: 8 }, waage: true,
      fallen_ops: [
    ...
    { id: "w4-02", stufe: 4, start: { xL: 4, cL: 1, xR: 2, cR: 7 }, waage: true,
      fallen_ops: [
    ...
    { id: "w4-03", stufe: 4, start: { xL: 5, cL: 2, xR: 2, cR: 11 }, waage: true,
      fallen_ops: [
    ...
    { id: "w4-04", stufe: 4, start: { xL: 3, cL: 4, xR: 1, cR: 10 }, waage: true,
      fallen_ops: [
        { op: { art: "div", wert: 3, seite: "beide" }, muster: "teilen-vor-sammeln",
    ...
    { id: "w4-05", stufe: 4, start: { xL: 4, cL: 3, xR: 1, cR: 9 }, waage: true,
      fallen_ops: [
        { op: { art: "div", wert: 4, seite: "beide" }, muster: "teilen-vor-sammeln",
    ...
    { id: "w4-06", stufe: 4, start: { xL: 6, cL: 1, xR: 2, cR: 9 }, waage: true,
      fallen_ops: [
  ...
  { nr: 5, name: "Ohne Waage weiterdenken", aufgaben: [
    ...
    { id: "w5-04", stufe: 5, start: { xL: 3, cL: 0, xR: 0, cR: -6 }, waage: false,
      fallen_ops: [
      ...
      musterweg: [{ art: "div", wert: 3, seite: "beide" }] },
    { id: "w5-05", stufe: 5, start: { xL: 2, cL: -1, xR: 1, cR: -4 }, waage: false,
      fallen_ops: [
    ...
    { id: "w5-06", stufe: 5, start: { xL: 4, cL: 2, xR: 0, cR: 1 }, waage: false,
      fallen_ops: [
...
if (typeof module !== 'undefined') {
  module.exports = { STUFEN, EMPFEHLUNGEN, MUSTER_TEXTE, TRAINER_NAMEN, EMPFEHLUNGS_SCHWELLE, TEXTE };
}
